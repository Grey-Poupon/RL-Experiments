...
def train():
    ...
    my_replay_memory =DamcyPER.Experience({'size':MEMORY_SIZE})
    ...
    with tf.Session() as sess:
        ...
        while frame_number < MAX_FRAMES:
            ...
            while epoch_frame < EVAL_FREQUENCY:
                ...
                for _ in range(MAX_EPISODE_LENGTH):
                    ...
                    my_replay_memory.store(s1, action, reward, atari.state, terminal)
        ...
        save_loc = "/data/Saves"
        saver.save(sess, save_loc + "/PER/Pong/Weights/" + str(frame_number))
        np.savez(        save_loc + "/PER/Pong/Logs/Logs_" + str(frame_number), loss_list, rewards, q_values)
