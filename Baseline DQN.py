...
def train():
    ...
    with tf.Session() as sess:
        ...
        np.savez("/data/Saves/Baseline/Pong/Memory/Memory", my_replay_memory.actions, my_replay_memory.rewards,
                 my_replay_memory.frames, my_replay_memory.terminal_flags)
        np.savez("/data/Saves/Baseline/Pong/Logs/Logs_" + str(frame_number), loss_list, rewards, q_values)
